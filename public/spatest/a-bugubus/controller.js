...
app
    ...
    * 次票控制器
    * */
    //.controller('TicketDayController',function($rootScope,$scope,$myHttpService){
    //    $scope.scheduleList=[];
    //    //定义请求状态
    //})
    ...
    .controller('TicketRechargeController', function($rootScope, $scope, $myHttpService, $location) {
        ...
        $scope.recharge = function(){
            //alert('openid:'+$rootScope.session.user.userInfo.openid);
    ...
    .controller('ScheduleTicketPaySuccess', function($rootScope, $scope, $location, $state, $stateParams) {
        $scope.orderInfoList = JSON.parse($stateParams.orderList);
